...
(function () {
  ...
  // Load saved language on page load (explicit user choice only —
  // no browser-language auto-detect, so first-time visitors and
  // crawlers always see pt-BR with matching metadata)
